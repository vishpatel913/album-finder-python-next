...
def get_artist_with_albums(
    ...
    result = ArtistDetails.model_validate(artist, from_attributes=True)
...
def list_artists_with_albums(
    ...
    results: list[ArtistDetails] = []
    for artist in artists:
        item = ArtistDetails.model_validate(artist, from_attributes=True)
